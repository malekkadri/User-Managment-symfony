...
class __TwigTemplate_71cdba4e7c1e995d7aa1f2a1069afd21 extends Template
{
    private $source;
    private $macros = [];
    ...
    {% if segment in app.request.attributes.get('_route') %}
        active
    {% endif %}
{% endmacro %}", "partials/_macro.html.twig", "C:\\Users\\Malik\\Desktop\\User-Crud-Symfony5-master\\templates\\partials\\_macro.html.twig");
    }
}
